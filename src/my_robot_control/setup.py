...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'my_robot_control_exec_lidar = my_robot_control.my_robot_control_lidar:main',
            ...
            'my_robot_wallfollower_holonomic_v1_exec = my_robot_control.my_robot_wallfollower_holonomic_v1:main',
            'my_robot_wallfollower_holonomic_julia_exec = my_robot_control.my_robot_wallfollower_holonomic_julia:main'
        ],
    },
)
